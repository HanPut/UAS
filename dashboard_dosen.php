...
// Ambil role dan user_id dari sesi
$role = $_SESSION['role'];
if ($role !== 'dosen') {
    header('Location: unauthorized.php');  // Jika bukan admin, redirect ke halaman tidak sah
    exit();
}
$username = isset($_SESSION['username']) ? $_SESSION['username'] : 'User';// Akses halaman admin...
...
<head>
    ...
    <title>SB Admin 2 - Dashboard Dosen</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Dashboard Dosen</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Universitas Danta 2025</span>
                    </div>
                </div>
            </footer>
            <!-- Akhir Footer -->
